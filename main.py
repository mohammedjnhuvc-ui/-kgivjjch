...
<section class="kpis"><div class="kpi good"><div class="cap">مصرف‌شده / حجم کل</div><div class="num" style="font-size:clamp(15px,2.4vw,19px)">__USED__ <span style="font-size:11px;color:#91a0b5;font-weight:700">/ __LIMIT__</span></div></div><div class="kpi warn"><div class="cap">باقی‌مانده</div><div class="num">__REMAINING__</div></div><div class="kpi blue"><div class="cap">IP فعال</div><div class="num">__IPS__</div></div><div class="kpi purple"><div class="cap">زمان باقی‌مانده</div><div class="num">__EXPIRY_REMAINING__</div></div></section>
